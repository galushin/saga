...
namespace saga
{
    ...
    public:
        ...
        /** @brief Если у @cur есть передняя пройденная часть, то после завершения первого прохода
        курсор вернётся к началу этой пройденной части. Это сделано для того, чтобы можно было
        организовать обход по циклу, начиная с произвольного места.
        */
