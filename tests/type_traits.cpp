...
static_assert(saga::is_equality_comparable<int>{});
static_assert(saga::is_equality_comparable<std::string>{});
static_assert(!saga::is_equality_comparable<std::greater<int>>{});

static_assert(saga::is_equality_comparable_with<int, int>{}, "regression #1335");
